...
<title>Ele Repara- php 5 Template Preview</title>
                            ...
                            <ul class="accordion-box">
                                <li class="accordion block active-block">
                                    ...
                                    <div class="acc-content current">
                                        <ul class="service-list clearfix">
                                            <li><a href="air-conditioning.php">Ar condicionado</a></li>
                                            <li><a href="serviços-de-aquecimento.php">Serviços de aquecimento</a></li>
                                            <li><a href="serviços-eletricos.php">Instalação e manunteção elétrica</a></li>
                                            <li><a href="painel-eletrico.php">Painéis Elétricos</a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li class="accordion block">
                                    ...
                                    <div class="acc-content">
                                        <ul class="service-list clearfix">
                                            <li><a href="air-conditioning.php">Ar condicionado</a></li>
                                            <li><a href="heating-service.php">Serviços de aquecimento</a></li>
                                            <li><a href="power-outlets.php">Instalação e manunteção elétrica</a></li>
                                            <li><a href="indoor-lighting.php">Painéis Elétricos</a></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
