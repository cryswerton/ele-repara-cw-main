                    ...
                    <div class="row clearfix">
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image-box p_relative d_block">
                                <figure class="image"><img src="http://elerepara.pt/assets/images/shop/shop-1.jpg" alt=""></figure>
                                <div class="preview-link p_absolute t_20 r_20"><a href="http://elerepara.pt/assets/images/shop/shop-1.jpg" class="lightbox-image p_relative d_iblock fs_20 centred z_1 w_50 h_50 color_black lh_50" data-fancybox="gallery"><i class="icon-63"></i></a></div>
                            </div>
                        </div>
                            ...
                            <div class="product-details p_relative d_block ml_20">
                                ...
                                <div class="addto-cart-box p_relative d_block mb_35"> 
                                    <ul class="clearfix">
                                        ...
                                        <li class="p_relative d_block float_left mr_10"><a href="shop-details.php" class="d_iblock p_relative fs_20 lh_50 w_50 h_50 centred b_radius_5"><i class="icon-62"></i></a></li>
                                        <li class="p_relative d_block float_left mr_10"><a href="shop.php" class="d_iblock p_relative fs_20 lh_50 w_50 h_50 centred b_radius_5"><i class="icon-63"></i></a></li>
                                    </ul>
                                </div>
                                <div class="other-option">
                                    <ul class="list">
                                        ...
                                        <li class="p_relative d_block fs_16 font_family_poppins"><span class="fw_medium color_black">Tags:</span> <a href="shop-details.php">Laptop</a>, <a href="shop-details.php">Device</a>, <a href="shop-details.php">Desktop</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="customer-inner">
                                    <div class="customer-review p_relative d_block pb_65 mb_65">
                                        ...
                                        <div class="comment-box p_relative d_block pl_110">
                                            <figure class="comment-thumb p_absolute l_0 t_0 w_80 h_80 b_radius_55"><img src="http://elerepara.pt/assets/images/shop/comment-1.jpg" alt=""></figure>
                                    ...
                                    <div class="customer-comments p_relative">
                                        ...
                                        <form action="shop-details.php" method="post" class="comment-form default-form">
                                            <div class="row clearfix">
