                        ...
                        <div class="team-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="shape" style="background-image: url(http://elerepara.pt/assets/images/shape/shape-8.png);"></div>
                                    <figure class="image">
                                        <img src="http://elerepara.pt/assets/images/team/team-1.jpg" alt="">
                                ...
                                <div class="lower-content p_relative d_block">
                                    <h3><a href="team-details.php">Jack Nicholson</a></h3>
                        ...
                        <div class="team-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="shape" style="background-image: url(http://elerepara.pt/assets/images/shape/shape-8.png);"></div>
                                    <figure class="image">
                                        <img src="http://elerepara.pt/assets/images/team/team-2.jpg" alt="">
                                        <ul class="social-links clearfix">
                                            <li><a href="index.php"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                                ...
                                <div class="lower-content p_relative d_block">
                                    <h3><a href="team-details.php">Robert Downey</a></h3>
                                    <span class="designation">Installation</span>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed eiusmod tempor.</p>
                                </div>
                            </div>
                        ...
                        <div class="team-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="shape" style="background-image: url(http://elerepara.pt/assets/images/shape/shape-8.png);"></div>
                                    <figure class="image">
                                        <img src="http://elerepara.pt/assets/images/team/team-3.jpg" alt="">
                                        <ul class="social-links clearfix">
                                            <li><a href="index.php"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-linkedin-in"></i></a></li>
                                ...
                                <div class="lower-content p_relative d_block">
                                    <h3><a href="team-details.php">Gerard Butler</a></h3>
                                    <span class="designation">Installation</span>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed eiusmod tempor.</p>
                                </div>
                            </div>
                        ...
                        <div class="team-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="shape" style="background-image: url(http://elerepara.pt/assets/images/shape/shape-8.png);"></div>
                                    <figure class="image">
                                        <img src="http://elerepara.pt/assets/images/team/team-7.jpg" alt="">
                                        <ul class="social-links clearfix">
                                            <li><a href="index.php"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                                ...
                                <div class="lower-content p_relative d_block">
                                    <h3><a href="team-details.php">David Corenswet</a></h3>
                                    <span class="designation">Installation</span>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed eiusmod tempor.</p>
                                </div>
                            </div>
                        ...
                        <div class="team-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="shape" style="background-image: url(http://elerepara.pt/assets/images/shape/shape-8.png);"></div>
                                    <figure class="image">
                                        <img src="http://elerepara.pt/assets/images/team/team-8.jpg" alt="">
                                        <ul class="social-links clearfix">
                                            <li><a href="index.php"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-linkedin-in"></i></a></li>
                                ...
                                <div class="lower-content p_relative d_block">
                                    <h3><a href="team-details.php">Harriet Samson</a></h3>
                                    <span class="designation">Installation</span>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed eiusmod tempor.</p>
                                </div>
                            </div>
                        ...
                        <div class="team-block-one">
                            <div class="inner-box">
                                <div class="image-box">
                                    ...
                                    <div class="shape" style="background-image: url(http://elerepara.pt/assets/images/shape/shape-8.png);"></div>
                                    <figure class="image">
                                        <img src="http://elerepara.pt/assets/images/team/team-9.jpg" alt="">
                                        <ul class="social-links clearfix">
                                            <li><a href="index.php"><i class="fab fa-facebook-f"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-twitter"></i></a></li>
                                            <li><a href="index.php"><i class="fab fa-linkedin-in"></i></a></li>
                                ...
                                <div class="lower-content p_relative d_block">
                                    <h3><a href="team-details.php">Daniel Hagen</a></h3>
                                    <span class="designation">Installation</span>
                                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit sed eiusmod tempor.</p>
                                </div>
                            </div>
